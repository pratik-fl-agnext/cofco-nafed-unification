...
public class FilterRepository {
    ...
    public List<Long> getScanDatesForAcceptance(Long regionId, Long commodityId, Long installationCenterId,
	    ...
	    Long deviceTypeId, String deviceSerialNo, Long operatorId, Long stateAdmin, Long stateId, String districtName) {
	StringBuilder sb = new StringBuilder();
	sb.append(
		"select cs.createdOn from ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId where 1=1 and cs.isValid = true");
	if (customerId != null) {
	    sb.append(" AND cs.customerId =:customerId");
	}
	if (operatorId != null) {
	...
	if (districtName!= null) {
		sb.append(" and sl.warehouseName=:districtName");
	}
	Query query = em.createQuery(sb.toString());
	if (regionId != null) {
	    query.setParameter("regionId", regionId);
    ...
    public List<Object[]> getCommodityIds(Long regionId, Long commodityId, Long installationCenterId, Long dateFrom,
	    ...
	    Long operatorId, Long stateAdmin, Long stateId, String districtName) {
	StringBuilder sb = new StringBuilder();
	sb.append(
		"select count(cs.commodityId), c.commodityName from ScanEntity as cs inner join DcmCommodity c on c.id=cs.commodityId inner join ScanLocation sl on sl.id=cs.installatonCenterId where 1=1 and cs.isValid = true");
	if (customerId != null) {
	    sb.append(" AND cs.customerId =:customerId");
	}
	if (operatorId != null) {
    ...
    public Long getScanCountPerDay(Long regionId, Long commodityId, Long installationCenterId, Object object,
	    ...
	    String deviceSerialNo, Long operatorId, Long stateAdmin, Long stateId, String districtName) {
	StringBuilder sb = new StringBuilder();
	sb.append(
		"select count(cs.id) from ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId where 1=1 and cs.isValid = true");
	if (customerId != null) {
	    sb.append(" AND cs.customerId =:customerId");
	}
	if (operatorId != null) {
    ...
    public List<Object[]> getAggrigateQuantity(Long commodityId, Long ccId, Long dateFrom, Long dateTo, Long customerId,
	    ...
	    Long stateId, Long categoryId, String districtName) {
	StringBuilder sb = new StringBuilder();
	sb.append(
		"SELECT avg(cs.weight),min(cs.weight),max(cs.weight),sum(cs.weight) FROM ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId where 1=1 and cs.isValid = true ");
    ...
    public List<Object[]> getCollectionsQuantityPerLocation(Long regionId, Long commodityId, Object object,
	    ...
	    Long operatorId, Long stateAdmin, Long stateId,Long categoryId, String districtName) {

	StringBuilder sb = new StringBuilder();
	sb.append(
		"SELECT cs.installatonCenterId,sum(cs.weight) FROM ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId  where 1=1 and cs.isValid = true ");
    ...
    public Object[] getCollectionsQuantityByLocation(Long commodityId, Long locationId, Long dateFrom, Long dateTo,
	    ...
	    Long stateAdmin, Long stateId, Long categoryId, String districtName) {
	StringBuilder sb = new StringBuilder();
	sb.append(
		"SELECT cs.installatonCenterId,sum(cs.weight) FROM ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId where  1=1 and cs.isValid = true");
    ...
    public List<Object[]> getCollectionDetailsOverTime(Integer pageNumber, Integer limit, Long customerId,
	    ...
	    String deviceSerialNo, Long operatorId, Long stateAdmin, Long stateId, Long categoryId, String districtName) {

	StringBuilder sb = new StringBuilder();
	sb.append(
		"SELECT sum(cs.weight),cs.createdOnDate,cs.createdOn FROM ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId  where 1=1 and cs.isValid = true ");
	...
	sb.append(
		"SELECT sum(cs.weight) FROM ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId  where 1=1 and cs.isValid = true ");
	...
	StringBuilder sb = new StringBuilder();
	sb.append(
		"SELECT sum(cs.weight),cs.createdOnDate,cs.createdOn,cs.id FROM ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId  where 1=1 and cs.isValid = true ");
	...
	StringBuilder sb = new StringBuilder();
	sb.append(
		"select count(cs.id) from ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId where cs.approval=1 and cs.isValid = true");
	if (customerId != null) {
	    sb.append(" AND cs.customerId =:customerId");
	}
	if (operatorId != null) {
	...
	if (districtName!= null) {
		...
		System.out.println("commodityCategory : " + categoryId);
		System.out.println();
		System.out.println("TotalAccepted : " + sb.toString());
	...
	System.out.println("(Long) query.getSingleResult() "+(Long) query.getSingleResult());
	return (Long) query.getSingleResult();
	...
	StringBuilder sb = new StringBuilder();
	sb.append(
		"select count(cs.id), count(cs.accepted), c.commodityName,cs.commodityId from ScanEntity as cs inner join DcmCommodity c on c.id=cs.commodityId inner join ScanLocation sl on sl.id=cs.installatonCenterId  where cs.approval=1 and cs.isValid = true ");
	if (customerId != null) {
	    sb.append(" AND cs.customerId =:customerId");
	}
	if (operatorId != null) {
	...
	StringBuilder sb = new StringBuilder();
	sb.append(
		"select count(cs.id), count(cs.accepted) from ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId  where cs.approval=1 and cs.isValid = true");
	if (customerId != null) {
	    sb.append(" AND cs.customerId =:customerId");
	}
	if (operatorId != null) {
    ...
    public Long getTotalScanVariance(Long regionId, Long commodityId, Long installationCenterId, Long dateFrom,
	    Long dateTo, Long customerId, Long categoryId, String deviceType, Long deviceTypeId, String deviceSerialNo,
	    Long operatorId, Long stateId, String districtName) {

	StringBuilder sb = new StringBuilder();
	sb.append(
		"select sum(cs.variance) from ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId where 1=1 and cs.isValid = true");
	if (customerId != null) {
	    sb.append(" AND cs.customerId =:customerId");
	}
	if (operatorId != null) {
    ...
    public List<Object[]> getVarianceSumByCommodity(Long regionId, Long commodityId, Long installationCenterId,
	    Long dateFrom, Long dateTo, Long customerId, Long categoryId, String deviceType, Long deviceTypeId,
	    String deviceSerialNo, Long operatorId, Long stateId, String districtName) {
	StringBuilder sb = new StringBuilder();
	sb.append(
		"select count(cs.id), sum(cs.variance), c.commodityName from ScanEntity as cs inner join DcmCommodity c on c.id=cs.commodityId inner join ScanLocation sl on sl.id=cs.installatonCenterId  where 1=1 and cs.isValid = true");
	if (customerId != null) {
	    sb.append(" AND cs.customerId =:customerId");
	}
	if (operatorId != null) {
	...
	StringBuilder sb = new StringBuilder();
	sb.append(
		"select count(cs.id), sum(cs.variance) from ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId  where 1=1 and cs.isValid = true");
	if (customerId != null) {
	    sb.append(" AND cs.customerId =:customerId");
	}
	if (operatorId != null) {
	...
	try {
	    ...
	    sb.append(
		    "SELECT cs.deviceType FROM ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId  where 1=1 and cs.isValid = true ");
	...
	try {
	    ...
	    sb.append(
		    "SELECT sum(cs.weight),cs.createdOnDate FROM ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId  where  1=1 and cs.isValid = true ");
	...
	StringBuilder sb = new StringBuilder();
	sb.append(
		"select sum(cs.weight),c.commodityName,cs.quantityUnit, cs.commodityId from ScanEntity as cs inner join DcmCommodity c on c.id=cs.commodityId inner join ScanLocation sl on sl.id=cs.installatonCenterId  where 1=1 and cs.isValid = true ");
	if (customerId != null) {
	    sb.append(" AND cs.customerId =:customerId ");
	}
	...
	StringBuilder sb = new StringBuilder();
	sb.append(
		"SELECT sum(cs.weight),cs.createdOnDate,cs.createdOn,cs.quantityUnit FROM ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId  where 1=1 and cs.isValid = true ");
	...
	Object[] obj = null;
	sb.append(
		"SELECT sum(cs.weight),cs.quantityUnit FROM ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId  where 1=1 and cs.isValid = true ");
	...
	List<Long> obj = null;
	sb.append(
		"SELECT cs.commodityId FROM ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId  where 1=1 and cs.isValid = true");
	...
	try {
	    Object[] sum = null;
	    sb.append(
		    "SELECT sum(cs.weight),cs.commodityName,cs.quantityUnit FROM ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId  where 1=1 and cs.isValid = true");
	...
	StringBuilder sb = new StringBuilder();
	sb.append(
		"SELECT distinct cs.installatonCenterId FROM ScanEntity as cs inner join ScanLocation sl on sl.id=cs.installatonCenterId  where 1=1 and cs.isValid = true ");
	...
	System.out.println();
	System.out.println("allScans query : "+ sb);
	System.out.println();
	Query query = em.createQuery(sb.toString());
	if (regionId != null) {
	    query.setParameter("regionId", regionId);
	...
	public Long getCommodityApproved(Long commodityId, Long installationCenterId, Long dateFrom, Long dateTo,
			Long customerId, Long categoryId, String deviceSerialNo, Long operatorId, Long stateAdmin, Long stateId, String districtName) {
		StringBuilder sb = new StringBuilder();
		sb.append(
			"select count(cs.id) from ScanEntity as cs inner join DcmCommodity c on c.id=cs.commodityId inner join ScanLocation sl on sl.id=cs.installatonCenterId  where cs.isValid = true ");
		if (customerId != null) {
		    sb.append(" AND cs.customerId =:customerId");
		}
		if (operatorId != null) {
	...
	public List<Object[]> getWarehouseData(Integer pageNumber, Integer limit, Long customerId, Long commodityCategoryId,
			Long dateFrom, Long dateTo, Long operatorId, Long stateAdmin, Long commodityId, Long stateId,
			String keyword, String locationName, String districtName) {
		StringBuilder sb = new StringBuilder();
		sb.append(
				"select cs.installatonCenterId,sl.locationName,sl.warehouseName,sl.code,sum(cs.weight),cs.deviceSerialNo from ScanEntity as cs left join ScanLocation sl on sl.id=cs.installatonCenterId where cs.installatonCenterId is not null and cs.isValid !=0 ");
		if (customerId != null) {
			sb.append(" and cs.customerId =:customerId");
		}
		...
		if (locationName!= null) {
			sb.append(" and sl.warehouseName=:locationName");
		}
		if (districtName!= null) {
			sb.append(" and sl.warehouseName=:districtName");
		}
		if (keyword != null) {
			sb.append(
					" and (COALESCE(:keyword, null) is null or lower(cs.deviceSerialNo) Like lower(concat('%', :keyword,'%')) or lower(cs.deviceType) Like lower(concat('%', :keyword,'%')) or lower(sl.warehouseName) Like lower(concat('%', :keyword,'%'))  or lower(cs.commodityName) Like lower(concat('%', :keyword,'%')) )");
		}
		sb.append(" GROUP BY cs.installatonCenterId");
		System.out.println("Query : " + sb.toString());
		Query query = em.createQuery(sb.toString());
	...
	public List<Object[]> getWarehouseDailyData(Long warehouseId,String keyword) {
		StringBuilder sb = new StringBuilder();
		sb.append(
			"select sum(cs.weight),cs.createdOnDate from ScanEntity as cs where cs.installatonCenterId is not null and cs.isValid !=0  ");
		if (warehouseId != null) {
		    sb.append(" and cs.installatonCenterId =:warehouseId");
		}
		if (keyword != null) {
			sb.append(
					" and (COALESCE(:keyword, null) is null or lower(cs.deviceSerialNo) Like lower(concat('%', :keyword,'%')) or lower(cs.deviceType) Like lower(concat('%', :keyword,'%'))  or lower(cs.commodityName) Like lower(concat('%', :keyword,'%')) )");
		}
		
            sb.append(" GROUP BY cs.createdOnDate order by cs.createdOnDate");
            System.out.println("Query : "+sb.toString());
		Query query = em.createQuery(sb.toString());
	...
	public BigDecimal getTotalCollections(Long customerId, Long commodityCategoryId, Long dateFrom, Long dateTo,
			Long operatorId, Long stateAdmin, Long commodityId, Long stateId, String keyword, String districtName) {
		
		StringBuilder sb = new StringBuilder();
		sb.append(
			"select sum(cs.weight) from ScanEntity as cs left join ScanLocation sl on cs.installatonCenterId=sl.id where 1=1 and cs.isValid !=0  ");
		if (customerId != null) {
		    sb.append(" and cs.customerId =:customerId");
		}
		...
		BigDecimal totalCollection= (BigDecimal) query.getSingleResult();
		return totalCollection;
	}
	
	public List<Object[]> getCommodityWiseCollection(Long customerId, Long commodityCategoryId, Long dateFrom, Long dateTo,
			Long operatorId, Long stateAdmin, Long commodityId, Long stateId, String keyword, String districtName) {
		
		StringBuilder sb = new StringBuilder();
		sb.append(
			"select cs.commodityId,cs.commodityName, sum(cs.weight) from ScanEntity as cs left join ScanLocation sl on cs.installatonCenterId=sl.id where 1=1 and cs.isValid !=0 ");
		if (customerId != null) {
		    sb.append(" and cs.customerId =:customerId");
		}
		...
		sb.append(" GROUP BY cs.commodityId ORDER BY cs.commodityId ASC");
		...
		List<Object[]> totalCommodityCollection=query.getResultList();
		return totalCommodityCollection;
	}
	
	public List<Object[]> getTotalCollectionsDailyData(Long customerId, Long commodityCategoryId, Long dateFrom, Long dateTo,
			Long operatorId, Long stateAdmin, Long commodityId, Long stateId, String keyword, String districtName) {
		
		StringBuilder sb = new StringBuilder();
		sb.append(
			"select cs.createdOnDate, sum(cs.weight) from ScanEntity as cs left join ScanLocation sl on cs.installatonCenterId=sl.id where 1=1 and cs.isValid !=0 ");
		if (customerId != null) {
		    sb.append(" and cs.customerId =:customerId");
		}
